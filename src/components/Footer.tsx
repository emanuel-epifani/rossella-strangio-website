        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#where" className="text-muted-foreground hover:text-accent transition-colors">
                  Dove ricevo
                </a>
              </li>
              <li>
                <a href="#prices" className="text-muted-foreground hover:text-accent transition-colors">
                  Tariffe
                </a>
              </li>
              <li>
